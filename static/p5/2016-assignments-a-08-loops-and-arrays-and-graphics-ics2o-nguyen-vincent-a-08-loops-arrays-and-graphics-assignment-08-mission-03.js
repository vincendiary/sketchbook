...
window.__SKETCHBOOK_P5__["2016-assignments-a-08-loops-and-arrays-and-graphics-ics2o-nguyen-vincent-a-08-loops-arrays-and-graphics-assignment-08-mission-03"] = function (p) {
	...
	with (p) {
		// assignment_08_mission_03.pde
		var numbers = new Array(20).fill(0);
		var speed = new Array(20).fill(0);
