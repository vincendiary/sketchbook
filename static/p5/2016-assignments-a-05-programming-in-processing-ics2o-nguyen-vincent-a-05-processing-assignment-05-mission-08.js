...
window.__SKETCHBOOK_P5__["2016-assignments-a-05-programming-in-processing-ics2o-nguyen-vincent-a-05-processing-assignment-05-mission-08"] = function (p) {
	...
	with (p) {
		...
		function draw() {
		 ...
		 // Pupils
		 var mx1 = constrain(mouseX,125,145);
		 var my1 = constrain(mouseY,175,195);
		 var mx2 = constrain(mouseX,155,175);
		 var my2 = constrain(mouseY,175,195);
		 // Left Pupil
		 fill("#363434");
		 stroke("#1A1919");
