...
window.__SKETCHBOOK_P5__["2017-summative-prototype-stage-05-24-2017-9-42-am-prototype"] = function (p) {
	...
	with (p) {
		...
		var Bullet = class Bullet {
		  ...
		  aoe() {
		    for (var i = 0; i < 9; i++) {
		      this.loca = new PVector( (this.p.x + 30 * i) - this.p.x, (this.p.y + 30 * i) - this.p.y);
		      this.rota = atan2(this.loca.y, this.loca.x) * 180 / PI;
		    }
		  }
