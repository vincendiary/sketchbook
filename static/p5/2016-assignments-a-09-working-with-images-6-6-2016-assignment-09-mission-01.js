...
window.__SKETCHBOOK_P5__["2016-assignments-a-09-working-with-images-6-6-2016-assignment-09-mission-01"] = function (p) {
	...
	with (p) {
		// assignment_09_mission_01.pde
		var img1;
		var img2;
		function setup() {
		  createCanvas(500, 400);
		  img1 = loadImage(sketchbookAsset("2016/ASSIGNMENTS/A-09 Working with Images/6-6-2016/assignment_09_mission_01/data/howcansheslap.jpeg"));
		  img2 = loadImage(sketchbookAsset("2016/ASSIGNMENTS/A-09 Working with Images/6-6-2016/assignment_09_mission_01/data/penguin.png"));
		}
