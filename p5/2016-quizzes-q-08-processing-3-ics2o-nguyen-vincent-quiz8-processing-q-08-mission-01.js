...
window.__SKETCHBOOK_P5__["2016-quizzes-q-08-processing-3-ics2o-nguyen-vincent-quiz8-processing-q-08-mission-01"] = function (p) {
	...
	with (p) {
		...
		function setup() {
		  ...
		  background(0);
		  for (var j = 0; j < 20; j++) { //repeats until 20 lines have been created
		    VertLine(j*20);
