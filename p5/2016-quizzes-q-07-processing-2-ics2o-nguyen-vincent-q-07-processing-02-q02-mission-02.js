...
window.__SKETCHBOOK_P5__["2016-quizzes-q-07-processing-2-ics2o-nguyen-vincent-q-07-processing-02-q02-mission-02"] = function (p) {
	...
	with (p) {
		// Q02_mission_02.pde
		var xLocation = 0;
		var xSpeed = 5; // The integer was set at 0. The location of the rectangle will not change if the speed is set to 0.
