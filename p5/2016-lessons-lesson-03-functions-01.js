...
window.__SKETCHBOOK_P5__["2016-lessons-lesson-03-functions-01"] = function (p) {
	...
	with (p) {
		...
		function drawCircle() {
		  ...
		  var dia = round(diameter);
		  var xCenter = random(800);
		  var yCenter = random(500);
